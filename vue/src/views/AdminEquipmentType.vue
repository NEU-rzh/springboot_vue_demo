    ...
    <el-table
      ...
      <el-table-column
        ...
        <template #default="scope">
          ...
          <el-popconfirm
              title="确定删除吗？" @confirm="handleDelete(scope.row.equipmentTypeId)"
          >
            <template #reference>
  ...
  methods:{
    ...
    save(){
      if (this.form.equipmentTypeId){
        request.put("/typeofequipment", this.form).then(res => {
          console.log(res)
          if (res.code === '0') {
            this.$message({
              type: "success",
        ...
        request.post("/typeofequipment", this.form).then(res => {
          console.log(res)
          if (res.code === '0') {
            this.$message({
              type: "success",
    ...
    handleDelete(id)
    {
      request.delete("/typeofequipment/"+id).then(res=>{
        if (res.code === '0') {
          this.$message({
            type: "success",
            message: "删除成功"
